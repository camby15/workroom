                ...
                <div class="timeline">
                    ...
                    <div class="timeline-lg-item timeline-item-left">
                        <div class="timeline-desk">
                            <div class="timeline-box">
                                ...
                                <span class="timeline-icon bg-danger-subtle">
                    ...
                    <div class="timeline-lg-item timeline-item-right">
                        <div class="timeline-desk">
                            <div class="timeline-box">
                                ...
                                <span class="timeline-icon bg-info-subtle">
                                    <i class="ri-record-circle-fill text-info"></i>
                                </span>
                    ...
                    <div class="timeline-lg-item timeline-item-left">
                        <div class="timeline-desk">
                            <div class="timeline-box">
                                <span class="arrow-alt"></span>
                                <span class="timeline-icon bg-warning-subtle">
                                    <i class="ri-record-circle-fill text-warning"></i>
                                </span>
                    ...
                    <div class="timeline-lg-item timeline-item-right">
                        <div class="timeline-desk">
                            <div class="timeline-box">
                                <span class="arrow"></span>
                                <span class="timeline-icon bg-success-subtle">
                    ...
                    <div class="timeline-lg-item timeline-item-left">
                        <div class="timeline-desk">
                            <div class="timeline-box">
                                <span class="arrow-alt"></span>
                                <span class="timeline-icon bg-primary-subtle">
                                    <i class="ri-record-circle-fill text-primary"></i>
                                </span>
                                <h4 class="mt-0 mb-1 fs-16">Conference call with UX team</h4>
                                <p class="text-muted"><small>21 July, 2019</small></p>
                                <p>
                                    Jonatha Smith added new milestone
                                    <span><a href="#">Pathek</a></span>
