                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">ShrinQ</a></li>
                        ...
                        <div class="card">
                            <div class="card-body text-center">
                                ...
                                <div class="avatar-md mx-auto">
                                    <span
                                        class="avatar-title bg-info-subtle border-info border border-opacity-25 text-info fw-normal fs-24 rounded-circle">
                                        <i class="ri-group-line"></i>
                                    </span>
                                </div>
                                <h2 class="my-3">
                                    $19
                                    <span class="text-uppercase fs-14 text-muted">/ Month</span>
                                </h2>
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-body text-center">
                                ...
                                <div class="avatar-md mx-auto">
                                    <span
                                        class="avatar-title bg-danger-subtle border-danger border border-opacity-25 text-danger fw-normal fs-24 rounded-circle">
                    ...
                    <div class="col-md-4">
                        <div class="card card-pricing">
                            <div class="card-body text-center">
                                ...
                                <div class="avatar-md mx-auto">
                                    <span
                                        class="avatar-title bg-info-subtle text-info border-info border border-opacity-25 fw-normal fs-24 rounded-circle">
