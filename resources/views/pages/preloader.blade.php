                            ...
                            <div class="dropdown-menu dropdown-menu-animated dropdown-lg" id="search-dropdown">
                                ...
                                <div class="dropdown-header noti-title">
                                    <h5 class="text-overflow mb-1">
                                        Found
                                        <b class="text-decoration-underline">08</b>
                                        results
                                    </h5>
                                </div>
                        ...
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarLayouts">
                                <ul class="side-nav-second-level">
                                    ...
                                    <li class="menu-item">
                                        <a class="menu-link" href="{{ route('second', ['layouts-eg', 'full-view']) }}">
                                            <span class="menu-text">Full View</span>
                                        </a>
                                    </li>
                                    <li class="menu-item">
                                        <a
                                            ...
                                            <span class="menu-text">Fullscreen View</span>
                                        </a>
                                    </li>
                                    <li class="menu-item">
                                        <a
                                            ...
                                            <span class="menu-text">Hover Menu</span>
                                        </a>
                                    </li>
                                    <li class="menu-item">
                                        <a class="menu-link" href="{{ route('second', ['layouts-eg', 'compact']) }}">
                                            <span class="menu-text">Compact</span>
                                        </a>
                                    </li>
                                    <li class="menu-item">
                                        <a class="menu-link" href="{{ route('second', ['layouts-eg', 'icon-view']) }}">
                                            <span class="menu-text">Icon View</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarIcons">
                                <ul class="side-nav-second-level">
                                    ...
                                    <li>
                                        <a href="{{ route('second', ['icons', 'bootstrapicons']) }}">
                                            Bootstrap Icons
                                        </a>
                                    </li>
                                </ul>
                                ...
                                <ul class="side-nav-second-level">
                                    <li class="side-nav-item">
                                        ...
                                        <div class="collapse" id="sidebarApexCharts">
                                            <ul class="side-nav-third-level">
                                                ...
                                                <li>
                                                    <a href="{{ route('second', ['charts', 'apex-bubble']) }}">
                                                        Bubble
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="{{ route('second', ['charts', 'apex-candlestick']) }}">
                                                        Candlestick
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="{{ route('second', ['charts', 'apex-column']) }}">
                                                        Column
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="{{ route('second', ['charts', 'apex-heatmap']) }}">
                                                        Heatmap
                                                    </a>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    <a href="{{ route('second', ['charts', 'apex-timeline']) }}">
                                                        Timeline
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="{{ route('second', ['charts', 'apex-boxplot']) }}">
                                                        Boxplot
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="{{ route('second', ['charts', 'apex-treemap']) }}">
                                                        Treemap
                                                    </a>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    <a href="{{ route('second', ['charts', 'apex-radialbar']) }}">
                                                        RadialBar
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="{{ route('second', ['charts', 'apex-scatter']) }}">
                                                        Scatter
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="{{ route('second', ['charts', 'apex-polar-area']) }}">
                                                        Polar Area
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="{{ route('second', ['charts', 'apex-sparklines']) }}">
                                                        Sparklines
                                                    </a>
                                                </li>
                                            </ul>
                                    ...
                                    <li class="side-nav-item">
                                        ...
                                        <div class="collapse" id="sidebarChartJSCharts">
                                            <ul class="side-nav-third-level">
                                                <li>
                                                    <a href="{{ route('second', ['charts', 'chartjs-area']) }}">
                                                        Area
                                                    </a>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    <a href="{{ route('second', ['charts', 'chartjs-line']) }}">
                                                        Line
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="{{ route('second', ['charts', 'chartjs-other']) }}">
                                                        Other
                                                    </a>
                                                </li>
                                            </ul>
                        ...
                        <div class="row">
                                            ...
                                            <div class="row text-center">
                                                ...
                                                <div class="col">
                                                    ...
                                                    <h3 class="fw-normal mb-3">
                                                        <span>
                                                            $6,523.25
                                                            <i class="ri-corner-right-up-fill text-success"></i>
                                                        </span>
                                                    </h3>
                                                </div>
                                                <div class="col">
                                                ...
                                                <div class="col">
                                                    ...
                                                    <h3 class="fw-normal mb-3">
                                                        <span>
                                                            69k
                                                            <i class="ri-corner-right-down-line text-danger"></i>
                                                        </span>
                                                    </h3>
                                                </div>
                                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="card">
                                    ...
                                    <div class="card-body p-0">
                                        <div
                                            class="alert alert-warning rounded-0 mb-0 border-end-0 border-start-0"
                                            role="alert">
                                            Something went wrong. Please
                                            <strong>
                                                <a href="#!" class="alert-link text-decoration-underline">refresh</a>
                                            </strong>
                                            to get new data!
                                        </div>
                                    </div>
                ...
                <div data-simplebar class="h-100">
                    <div class="card mb-0 p-3">
                        <div class="alert alert-warning" role="alert">
                            ...
                            the overall color scheme, sidebar menu, etc.
                        </div>
