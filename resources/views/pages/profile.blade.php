                                ...
                                <div class="timeline-alt pb-0">
                                    <div class="timeline-item">
                                        ...
                                        <div class="timeline-item-info">
                                            ...
                                            <p class="fs-14">
                                                websitename.com
                                                <span class="ms-2 fs-12">Year: 2015 - 18</span>
                                            </p>
                                    ...
                                    <div class="timeline-item">
                                        ...
                                        <div class="timeline-item-info">
                                            ...
                                            <p class="fs-14">
                                                Software Inc.
                                                <span class="ms-2 fs-12">Year: 2012 - 15</span>
                                            </p>
                                            <p class="text-muted mt-2 mb-0 pb-3">
                                    ...
                                    <div class="timeline-item">
                                        ...
                                        <div class="timeline-item-info">
                                            ...
                                            <p class="fs-14">
                                                ...
                                                <span class="ms-2 fs-12">Year: 2010 - 12</span>
                                            </p>
                            ...
                            <div class="tab-pane" id="timeline">
                                ...
                                <div class="border rounded mt-2 mb-3">
                                    <form action="#" class="comment-area-box">
                                        ...
                                        <div class="p-2 bg-light d-flex justify-content-between align-items-center">
                                            <div>
                                                <a href="#" class="btn btn-sm px-2 fs-16 btn-light">
                                ...
                                <div class="border border-light rounded p-2 mb-3">
                                    ...
                                    <div class="fs-16 text-center fst-italic text-dark">
                                        <i class="ri-double-quotes-l fs-20"></i>
                                        Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante
                                        sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra
                                        turpis. Duis sagittis ipsum. Praesent mauris. Fusce nec tellus sed augue semper
                                        porta. Mauris massa.
                                    </div>
                                    ...
                                    <div class="mx-n2 p-2 mt-3 bg-light">
                                        <div class="d-flex">
                                            ...
                                            <div>
                                                <h5 class="mt-0">
                                                    Jeremy Tomlinson
                                                    <small class="text-muted">about 2 minuts ago</small>
                                                </h5>
