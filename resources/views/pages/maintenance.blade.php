                                ...
                                <div class="text-center">
                                    ...
                                    <div class="row mt-5">
                                        ...
                                        <div class="col-md-4">
                                            <div class="text-center mt-3 ps-1 pe-1">
                                                ...
                                                <p class="text-muted">
                                                    ...
                                                    It has roots in a piece of classical but the majority.
                                                </p>
                                            </div>
                                        </div>
                                        <!-- end col-->
                                        <div class="col-md-4">
                                            <div class="text-center mt-3 ps-1 pe-1">
                                                <i
                                                    class="ri-question-mark bg-primary maintenance-icon text-white mb-4"></i>
                                                <h5 class="text-uppercase">Do you need Support?</h5>
                                                <p class="text-muted">
                                                    If you are going to use a passage of Lorem Ipsum, you need to be
                                                    sure there isn't anything embar..
                                                    <a href="mailto:#" class="text-muted fw-bold">
                                                        no-reply@domain.com
                                                    </a>
                                                </p>
                                            </div>
