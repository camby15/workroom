                                ...
                                <div class="card-body p-3">
                                    ...
                                    <div class="avatar-group mt-2">
                                        ...
                                        <a
                                            ...
                                            title="Hooker">
                                            <div class="avatar-xs">
                                                <div class="avatar-title rounded-circle text-bg-success">K</div>
                                            </div>
                                        </a>
                                        <a
                                            href="javascript: void(0);"
                                            ...
                                            title="More +">
                                            <div class="avatar-xs">
                                                <div class="avatar-title rounded-circle">9+</div>
                                            </div>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="card-body p-3">
                                    ...
                                    <div class="avatar-group mt-2">
                                        ...
                                        <a
                                            ...
                                            title="Hooker">
                                            <div class="avatar-xs">
                                                <div class="avatar-title rounded-circle text-bg-info">M</div>
                                            </div>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="card-body p-3">
                                    ...
                                    <div class="avatar-group mt-2">
                                        ...
                                        <a
                                            ...
                                            title="Hooker">
                                            <div class="avatar-xs">
                                                <div class="avatar-title rounded-circle text-bg-warning">K</div>
                                            </div>
                                        </a>
                                        <a
                                            href="javascript: void(0);"
                                ...
                                <div class="card-body p-3">
                                    ...
                                    <div class="avatar-group mt-2">
                                        ...
                                        <a
                                            ...
                                            title="Hooker">
                                            <div class="avatar-xs">
                                                <div class="avatar-title rounded-circle text-bg-light">D</div>
                                            </div>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="card-body p-3">
                                    ...
                                    <div class="avatar-group mt-2">
                                        <a
                                            ...
                                            title="Hooker">
                                            <div class="avatar-xs">
                                                <div class="avatar-title rounded-circle text-bg-primary">M</div>
                                            </div>
                                        </a>
                                        <a
                                            href="javascript: void(0);"
                                            ...
                                            title="Hooker">
                                            <div class="avatar-xs">
                                                <div class="avatar-title rounded-circle text-bg-info">A</div>
                                            </div>
                                        </a>
                                        <a
                                            href="javascript: void(0);"
                                ...
                                <div class="card-body p-3">
                                    ...
                                    <div class="avatar-group mt-2">
                                        ...
                                        <a
                                            ...
                                            title="Hooker">
                                            <div class="avatar-xs">
                                                <div class="avatar-title rounded-circle text-bg-danger">K</div>
                                            </div>
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane show active" id="home-b1">
                                ...
                                <div class="text-end">
                                    <div class="btn-group mb-2 d-none d-sm-inline-block">
                                        <button type="button" class="btn btn-link btn-sm text-muted fs-18">
