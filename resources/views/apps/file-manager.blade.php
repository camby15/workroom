                        ...
                        <div class="page-aside-left">
                            <div class="btn-group d-block mb-2">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="#">
                                        <i class="ri-folder-5-line me-1"></i>
                                        Folder
                                    </a>
                                    <a class="dropdown-item" href="#">
                            ...
                            <div class="email-menu-list mt-3">
                                <a href="#" class="list-group-item border-0">
                                    <i class="ri-folders-line fs-18 align-middle me-2"></i>
                                    My Files
                                </a>
                                <a href="#" class="list-group-item border-0">
                                    <i class="ri-drive-line fs-18 align-middle me-2"></i>
                                    Google Drive
                                </a>
                                <a href="#" class="list-group-item border-0">
                                    <i class="ri-dropbox-line fs-18 align-middle me-2"></i>
                                    Dropbox
                                </a>
                                <a href="#" class="list-group-item border-0">
                                    <i class="ri-user-voice-line fs-18 align-middle me-2"></i>
                                    Share with me
                                </a>
                                <a href="#" class="list-group-item border-0">
                                    <i class="ri-time-line fs-18 align-middle me-2"></i>
                                    Recent
                                </a>
                                <a href="#" class="list-group-item border-0">
                                    <i class="ri-star-line fs-18 align-middle me-2"></i>
                                    Starred
                                </a>
                                <a href="#" class="list-group-item border-0">
                                    <i class="ri-delete-bin-line fs-18 align-middle me-2"></i>
                                    Deleted Files
                                </a>
                            </div>
                                    ...
                                    <table class="table table-centered table-nowrap table-borderless table-hover mb-0">
                                        ...
                                        <tbody>
                                                ...
                                                <td class="">
                                                    <div class="btn-group dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <a class="dropdown-item" href="#">
                                                                <i
                                                                    class="ri-share-line me-2 text-muted vertical-middle"></i>
                                                                Share
                                                            </a>
                                                            <a class="dropdown-item" href="#">
                                                                <i class="ri-link me-2 text-muted vertical-middle"></i>
                                                                Get Sharable Link
                                                            </a>
                                                            <a class="dropdown-item" href="#">
                                                                <i
                                                                    class="ri-pencil-line me-2 text-muted vertical-middle"></i>
                                                                Rename
                                                            </a>
                                                            <a class="dropdown-item" href="#">
                                                                <i
                                                                    class="ri-download-line me-2 text-muted vertical-middle"></i>
                                                                Download
                                                            </a>
                                                            <a class="dropdown-item" href="#">
                                                                <i
                                                                    class="ri-delete-bin-line me-2 text-muted vertical-middle"></i>
                                                                Remove
                                                            </a>
                                                        </div>
                                                    </div>
                                            ...
                                            <tr>
                                                <td>
                                                    <span class="fw-semibold">
                                                        <a href="javascript: void(0);" class="text-reset">Wireframes</a>
                                                    </span>
                                                </td>
                                                <td>
