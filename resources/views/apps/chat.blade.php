                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex align-items-start mb-3">
                            ...
                            <div class="w-100">
                                <h5 class="mb-0">
                                    <a href="{{ route('second', ['pages', 'profile']) }}" class="text-reset lh-base">
                                        Tosha Minner
                                    </a>
                                </h5>
                                <p class="mb-0 text-muted">
                                    <small class="ri-checkbox-blank-circle-fill text-success"></small>
                                    Online
                                </p>
                            </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <div data-simplebar style="max-height: 380px">
                                    ...
                                    <a href="javascript:void(0);" class="text-body">
                                        <div
                                            class="d-flex align-items-start py-2 px-3 bg-light-subtle border-top border-bottom border-light">
                                            <img
                                    ...
                                    <a href="javascript:void(0);" class="text-body">
                                        <div class="d-flex align-items-start py-2 px-3">
                                            ...
                                            <div class="w-100">
                                                ...
                                                <p class="mt-1 mb-0 text-muted">
                                                    <span class="w-75">
                                                        Are you free for 15 min? I would like to discuss something...
                                                    </span>
                                                </p>
                                            </div>
                                        </div>
                                ...
                                <div class="d-flex align-items-start">
                                    ...
                                    <div>
                                        <h5 class="my-0 font-15">
                                            <a href="{{ route('second', ['pages', 'profile']) }}" class="text-reset">
                                                James Zavel
                                            </a>
                                        </h5>
                                        <p class="mt-1 mb-0 text-muted fs-12">
                                            <small class="ri-checkbox-blank-circle-fill text-danger"></small>
                                            Offline
                                        </p>
                                    </div>
                                </div>
                        ...
                        <ul class="conversation-list p-3" data-simplebar style="max-height: 520px">
                            <li class="clearfix">
                                ...
                                <div class="conversation-actions dropdown">
                                    <button
                                        class="btn btn-sm btn-link fs-18"
                                    ...
                                    <div class="card mt-2 mb-1 shadow-none border text-start">
                                        <div class="p-2">
                                            <div class="row align-items-center">
                                                <div class="col-auto">
                                                    <div class="avatar-sm">
                                                        <span class="avatar-title bg-primary rounded">.ZIP</span>
                                                    </div>
                                                </div>
                                                <div class="col ps-0">
