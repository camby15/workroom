                ...
                <div class="card cta-box text-bg-info">
                    <div class="card-body">
                        <div class="text-center">
                            ...
                            <img
                                class="my-3"
                                src="/images/svg/startman.svg"
                                width="138"
                                alt="Generic placeholder image" />

                            <br />

                            <a href="javascript:void(0);" class="btn btn-sm btn-light rounded-pill">
                                Know More
                    ...
                    <div class="card-body py-0 mb-3" data-simplebar style="max-height: 315px">
                        <div class="timeline-alt py-0">
                            ...
                            <div class="timeline-item">
                                ...
                                <div class="timeline-item-info">
                                    <a href="#" class="text-primary fw-bold mb-1 d-block">
