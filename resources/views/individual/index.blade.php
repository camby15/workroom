@extends('layouts.vertical', ['page_title' => 'Dashboard - Individual', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('content')
                ...
                <div class="card">
                    ...
                    <div class="card-body p-0">
                        <div class="alert alert-warning rounded-0 mb-0 border-end-0 border-start-0" role="alert">
                            ...
                            <strong><a href="#!" class="alert-link text-decoration-underline">refresh</a></strong>
                            to get new data!
                        </div>
                    </div>
    ...
    <!-- Check for success message and trigger SweetAlert -->
    <script>
        @if(session('success'))
            Swal.fire({
                icon: 'success',
