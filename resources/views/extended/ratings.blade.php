            ...
            <div class="col-xl-6">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div
                            class="rateit rateit-remix"
                            data-rateit-backingfld="#backing3b"
                            data-rateit-mode="font"
                            data-rateit-icon="&#xF186;"></div>
                    </div>
                    <!-- end card-body -->
                </div>
                <!-- end card-->
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div style="direction: rtl">
                            <div class="rateit rateit-remix" data-rateit-mode="font" data-rateit-icon="&#xF186;"></div>
                        </div>
                    </div>
                    <!-- end card-body -->
                </div>
            ...
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="rateit rateit-remix mt-3" data-rateit-mode="font" data-rateit-icon="&#xEE0F;"></div>
                    </div>
                    <!-- end card-body -->
                </div>
                <!-- end card-->
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-wrap gap-2 mt-3">
                            ...
                            <button class="btn btn-sm btn-primary" onclick="alert($('#getting-values').rateit('max'))">
                                Get max value
                            </button>
                            <button
                                class="btn btn-sm btn-primary"
                            ...
                            <button class="btn btn-sm btn-primary" onclick="alert($('#getting-values').rateit('step'))">
                                Get step size
                            </button>
                            <button
                                class="btn btn-sm btn-primary"
