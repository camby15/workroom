                    ...
                    <div class="card-body">
                        ...
                        <div class="page-aside-left">
                            ...
                            <div class="mt-4">
                                ...
                                <div class="email-menu-list labels-list mt-2">
                                    <a href="javascript: void(0);">
                                        <i class="ri-checkbox-blank-circle-fill fs-13 text-info me-2"></i>
                                        Updates
                                    </a>
                                    <a href="javascript: void(0);">
                                        <i class="ri-checkbox-blank-circle-fill fs-13 text-warning me-2"></i>
                                        Friends
                                    </a>
                                    <a href="javascript: void(0);">
                                        <i class="ri-checkbox-blank-circle-fill fs-13 text-success me-2"></i>
                                        Family
                                    </a>
                                    <a href="javascript: void(0);">
                                        <i class="ri-checkbox-blank-circle-fill fs-13 text-primary me-2"></i>
                                        Social
                                    </a>
                                    <a href="javascript: void(0);">
                                        <i class="ri-checkbox-blank-circle-fill fs-13 text-danger me-2"></i>
                                        Important
                                    </a>
                                    <a href="javascript: void(0);">
                                        <i class="ri-checkbox-blank-circle-fill fs-13 text-secondary me-2"></i>
                                        Promotions
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="page-aside-right">
                            <div class="btn-group">
                                ...
                                <button type="button" class="btn btn-secondary">
                                    <i class="ri-spam-2-line fs-16"></i>
                                </button>
                                <button type="button" class="btn btn-secondary">
                                    ...
                                    <li class="unread">
                                        ...
                                        <div class="email-content">
                                            <a href="javascript: void(0);" class="email-subject">
                                                Lucas Kriebel (
                                                @LucasKriebel
                                                ) has sent you a direct message on Twitter! &nbsp;&ndash;&nbsp;
                                                <span>
                                                    @LucasKriebel
                                                    - Very cool :) Nicklas, You have a new direct message.
                                                </span>
                                            </a>
                                        ...
                                        <div class="email-action-icons">
                                            <ul class="list-inline">
                                                <li class="list-inline-item">
                                                    <a href="javascript: void(0);">
                                                        <i class="ri-archive-line email-action-icons-item"></i>
                                                    </a>
                                                </li>
                                                <li class="list-inline-item">
                                                    <a href="javascript: void(0);">
                                                        <i class="ri-delete-bin-6-line email-action-icons-item"></i>
                                                    </a>
                                                </li>
                                                <li class="list-inline-item">
                                                    <a href="javascript: void(0);">
                                                        <i class="ri-mail-open-line email-action-icons-item"></i>
                                                    </a>
                                                </li>
                                                <li class="list-inline-item">
                                                    <a href="javascript: void(0);">
                                                        <i class="ri-time-line email-action-icons-item"></i>
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    <li>
                                        ...
                                        <div class="email-content">
                                            <a href="javascript: void(0);" class="email-subject">
                                                ...
                                                <span>
                                                    ...
                                                    train ride between Colombo and Kandy? The one with the mountain
                                                    view? I would love to see that one again!
                                                </span>
                                            </a>
                                        ...
                                        <div class="email-action-icons">
                                            <ul class="list-inline">
                                                ...
                                                <li class="list-inline-item">
                                                    <a href="javascript: void(0);">
                                                        <i class="ri-mail-unread-line email-action-icons-item"></i>
                                                    </a>
                                                </li>
                                                <li class="list-inline-item">
                                                    <a href="javascript: void(0);">
                                    ...
                                    <li>
                                        ...
                                        <div class="email-content">
                                            <a href="javascript: void(0);" class="email-subject">
                                                ...
                                                <span>
                                                    You've been confirmed! Welcome to the ruling class of the inbox. For
                                                    your records, here is a copy of the information you submitted to
                                                    us...
                                                </span>
                                            </a>
                                    ...
                                    <li class="unread">
                                        ...
                                        <div class="email-content">
                                            <a href="javascript: void(0);" class="email-subject">
                                                ...
                                                <span>
                                                    Hej Nicklas Sandell! Vi vill bjuda in dig till "First tour 2014",
                                                    ett rekryteringsevent som erbjuder jobb på 16 semesterorter
                                                    iSverige.
                                                </span>
                                            </a>
                                            <div class="email-date">Mar 8</div>
                                    ...
                                    <li>
                                        ...
                                        <div class="email-content">
                                            <a href="javascript: void(0);" class="email-subject">
                                                ...
                                                <span>
                                                    Eff that place, you might as well stay here with us instead! Sent
                                                    from my iPhone 4 &gt; 4 mar 2014 at 5:55 pm
                                                </span>
                                            </a>
                                        ...
                                        <div class="email-content">
                                            <a href="javascript: void(0);" class="email-subject">
                                                ...
                                                <span>
                                                    ...
                                                    for the weekend. Here are some trending tracks and playlists we
                                                    think you should give a listen!
                                                </span>
                                            </a>
                                    ...
                                    <li>
                                        ...
                                        <div class="email-content">
                                            <a href="javascript: void(0);" class="email-subject">
                                                ...
                                                <span>
                                                    You have been assigned a task by Alex
                                                    @Work
                                                    on the board Web.
                                                </span>
                                            </a>
