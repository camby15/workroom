@extends('layouts.vertical', ['page_title' => 'Edit Customer'])
            ...
            <form action="{{ route('company.customers.update', $customer->id) }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="company_name" id="company_name" value="{{ old('company_name', $customer->company_name) }}" required placeholder=" ">
                        ...
                        <div class="col-md-8">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="address" id="address" value="{{ old('address', $customer->address) }}" required placeholder=" ">
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            <div class="form-floating mb-3">
                                <input type="date" class="form-control" name="commencement_date" id="commencement_date" value="{{ old('commencement_date', $customer->commencement_date) }}" placeholder=" ">
                                <label for="commencement_date">Commencement Date</label>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="sector" id="sector" value="{{ old('sector', $customer->sector) }}" required placeholder=" ">
                                <label for="sector">Sector</label>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-floating mb-3">
                                <input type="number" class="form-control" name="number_of_employees" id="number_of_employees" value="{{ old('number_of_employees', $customer->number_of_employees) }}" min="0" placeholder=" ">
                                <label for="number_of_employees">Number of Employees</label>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-floating mb-3">
                                <input type="tel" class="form-control" name="corporate_telephone" id="corporate_telephone" value="{{ old('corporate_telephone', $customer->corporate_telephone) }}" placeholder=" ">
                                <label for="corporate_telephone">Corporate Telephone</label>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-floating mb-3">
                                <input type="email" class="form-control" name="corporate_email" id="corporate_email" value="{{ old('corporate_email', $customer->corporate_email) }}" placeholder=" ">
                                <label for="corporate_email">Corporate Email</label>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="headquarters_address" id="headquarters_address" value="{{ old('headquarters_address', $customer->headquarters_address) }}" required placeholder=" ">
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="primary_contact_name" id="primary_contact_name" value="{{ old('primary_contact_name', $customer->primary_contact_name) }}" placeholder=" ">
                                <label for="primary_contact_name">Primary Contact Name</label>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="primary_contact_position" id="primary_contact_position" value="{{ old('primary_contact_position', $customer->primary_contact_position) }}" placeholder=" ">
                                <label for="primary_contact_position">Position</label>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-floating mb-3">
                                <input type="tel" class="form-control" name="primary_contact_number" id="primary_contact_number" value="{{ old('primary_contact_number', $customer->primary_contact_number) }}" placeholder=" ">
                                <label for="primary_contact_number">Contact Number</label>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-floating mb-3">
                                <input type="email" class="form-control" name="primary_contact_email" id="primary_contact_email" value="{{ old('primary_contact_email', $customer->primary_contact_email) }}" placeholder=" ">
                                <label for="primary_contact_email">Contact Email</label>
                            </div>
                        </div>
                        <div class="col-md-8">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="primary_contact_address" id="primary_contact_address" value="{{ old('primary_contact_address', $customer->primary_contact_address) }}" placeholder=" ">
                                <label for="primary_contact_address">Contact Address</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            <div class="form-floating mb-3">
                                <select class="form-select" name="customer_category" id="customer_category" required>
                                    ...
                                    <option value="Standard" {{ old('customer_category', $customer->customer_category) == 'Standard' ? 'selected' : '' }}>Standard</option>
                                    <option value="VIP" {{ old('customer_category', $customer->customer_category) == 'VIP' ? 'selected' : '' }}>VIP</option>
                                    <option value="HVC" {{ old('customer_category', $customer->customer_category) == 'HVC' ? 'selected' : '' }}>HVC</option>
                                </select>
                        ...
                        <div class="col-md-4">
                            <div class="form-floating mb-3">
                                ...
                                <label for="value">Customer Value</label>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-floating mb-3">
                                <select class="form-select" name="status" id="statuss" required>
                                    ...
                                    <option value="VIP" {{ old('status', $customer->status) == 'VIP' ? 'selected' : '' }}>VIP</option>
                                    <option value="Regular" {{ old('status', $customer->status) == 'Regular' ? 'selected' : '' }}>Regular</option>
                        ...
                        <div class="col-md-4">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="change_type" id="change_type" value="{{ old('change_type', $customer->change_type) }}" placeholder=" ">
                        ...
                        <div class="col-md-4">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="company_group_code" id="company_group_code" value="{{ old('company_group_code', $customer->company_group_code) }}" placeholder=" ">
