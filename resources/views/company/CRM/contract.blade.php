                            ...
                            <table class="table table-centered table-hover dt-responsive nowrap w-100" id="contractTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><span class="badge bg-{{ $contract->status === 'draft' ? 'warning' : 'success' }} justify-center">{{ ucfirst($contract->status) }}</span></td>
                                        <td>
                                            <div class="action-buttons">
                                                
                                                <button class="btn btn-sm btn-warning action-btn me-1" onclick="editContract({{ $contract->id }})">
                                                    <i class="fas fa-edit"></i>
                                                </button>
                                                @if($contract->file_path)
                                                <button class="btn btn-sm btn-success action-btn me-1" onclick="downloadContract({{ $contract->id }})">
                                                    <i class="fas fa-download"></i>
                                                </button>
                                                @endif
                                                <button class="btn btn-sm btn-primary action-btn me-1" onclick="sendForSignature({{ $contract->id }})" 
                                                    data-id="{{ $contract->id }}" 
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="text" class="form-control" id="edit_contract_name" name="contract_name" placeholder=" " required>
                                <label for="edit_contract_name">Contract Name *</label>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="text" class="form-control" id="edit_customer_name" name="customer_name" placeholder=" " required>
                        ...
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="date" class="form-control" id="edit_start_date" name="start_date" placeholder=" " required>
                                <label for="edit_start_date">Start Date *</label>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="date" class="form-control" id="edit_end_date" name="end_date" placeholder=" " required>
...
<div class="modal fade" id="sendForSignatureModal" tabindex="-1" aria-labelledby="sendForSignatureModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                <form id="sendForSignatureForm" method="POST">
                    ...
                    <div class="form-floating mb-3">
                        <input type="email" class="form-control" id="signerEmail" name="signer_email" placeholder="Signer's Email" required>
                        <label for="signerEmail">Customer's Email</label>
                    </div>
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="signerName" name="signer_name" placeholder="Signer's Name" required>
...
<div class="modal fade" id="addContractModal" tabindex="-1" aria-labelledby="addContractModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form id="addContractForm" onsubmit="addContract(event)">
                @csrf
                <div class="modal-body">
                    <div class="row g-3">
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="text" class="form-control" name="name" id="contract_name" placeholder=" " required>
    ...
    function addContract() {
        ...
        .then(data => {
            if (data.success) {
                ...
                location.reload(); // Refresh the page to show new contract
            } else {
