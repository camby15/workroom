                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div>
                                ...
                                <a href="#" class="link-success link-offset-3 fw-bold">
                                    Go Premium
                            ...
                            <img
                                class="ms-3"
                                src="/images/svg/email-campaign.svg"
                                width="92"
            ...
            <div class="col-xl-4 col-lg-6">
                <div class="card">
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-6">
                                <h5 class="text-uppercase fs-13 mt-0 text-truncate" title="Views per minute">
                                    Views per minute
                                </h5>
                        ...
                        <div class="mt-1 text-center">
                            <ul class="list-inline mb-0">
                                <li class="list-inline-item">
                                    <img class="ms-3 pe-1" src="/images/browsers/chrome.png" height="18" alt="chrome" />
                                ...
                                <li class="list-inline-item">
                                    <img class="ms-3 pe-1" src="/images/browsers/safari.png" height="18" alt="chrome" />
                                    <span class="align-middle">9.68%</span>
                                </li>
                                <li class="list-inline-item">
                                    <img class="ms-3 pe-1" src="/images/browsers/web.png" height="18" alt="chrome" />
                                    <span class="align-middle">36.87%</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body pt-0">
                        <div
                            ...
                            data-colors="#16a7e9,#47ad77,#ffc35a,#f15776"></div>
            ...
            <div class="col-xxl-6">
                <div class="card">
                    ...
                    <div class="card-body pt-0">
                        <div class="row">
                            <div class="col-lg-7">
                                <div id="world-map-markers" class="mt-3 mb-3" style="height: 332px"></div>
                            </div>
                            <div class="col-lg-5">
